...
</head><body><div class="card"><div class="icon">🔒</div><h1>Accès refusé</h1><p>Vous n'avez pas accès à cette application.<br>Contactez l'administrateur.</p><a href="<?= htmlspecialchars(GUARD_ERP_URL) ?>">Retour à l'ERP</a></div></body></html><?php
    exit;
}
